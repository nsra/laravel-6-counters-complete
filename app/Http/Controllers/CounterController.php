...
use App\Imports\ImportCounter;
use App\Exports\ExportCounter;
...
class CounterController extends Controller
{
    ...
    public function importView(Request $request){
        return view('importFile_counter');
    }

    public function import(Request $request){
        \Excel::import(new ImportCounter, $request->file('file')->store('files'));
        return redirect()->back();
    }

    public function exportCounters(Request $request){
        return \Excel::download(new ExportCounter, 'counters.xlsx');
    }
}
